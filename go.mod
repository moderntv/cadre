module github.com/moderntv/cadre
...
require (
	...
	github.com/polyfloyd/go-errorlint v1.2.0 // indirect
...
// replace github.com/simplesurance/grpcconsulresolver => ../grpcconsulresolver
